...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              //<a href="list.php?country=Canada" role="button" class="btn btn-default"> Canada</a> 
                foreach($countries as $args)
             
                    echo "<a href=\"list.php?country=$args role=\"button\" class=\"btn btn-default\">$args</a> ";
 ...
 foreach ($images as $arg)
              echo "           
           <li>
                 <a href=\"detail.php?id=".$arg["id"]." class=\"img-responsive\">
                 	<img src=\"images/square/".$arg["path"]."\"  alt=".$arg["title"].">
                 	<div class=\"caption\">
                 		<div class=\"blur\">
                 		</div>
